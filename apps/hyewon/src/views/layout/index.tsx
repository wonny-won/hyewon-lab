...
import Navigation from './nav/ui/navigation';
	...
	return (
		<>
			...
			<div className='w-full overflow-hidden flex flex-col'>
				...
				<main className='w-full h-full overflow-hidden px-50 min-[1450px]:px-95 max-sm:px-5 max-[1100px]:px-20 max-[1200px]:px-25'>
					{children}
				</main>
				<Footer />
			</div>
