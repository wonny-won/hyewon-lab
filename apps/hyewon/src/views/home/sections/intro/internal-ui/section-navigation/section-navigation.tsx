...
const SectionNavigation = ({ onClick }: NavigationProps) => {
	...
	return (
		<ul className='max-w-full grid max-[1297px]:grid-rows-[1fr_1fr] min-[1300px]:grid-cols-[1fr_1fr] max-[1300px]:gap-5 min-[1300px]:gap-30 mx-auto max-[1300px]:overflow-x-auto max-[800px]:overflow-hidden'>
