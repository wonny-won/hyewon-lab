		...
		main: [
			{
				...
				subtitle: [
					...
					},
					{
						...
						children: [
							{
								childTxt: '실무진 니즈를 반영한 핵심 기능 기획 및 구현',
								desc: null,
							},
							{
								childTxt: '기존 리소스를 활용한 MVP 성격의 빠른 제작/배포로 업무 효율성 극대화',
								desc: null,
							},
							{
								childTxt: '개발 일정 리드 및 협업 조율',
								desc: null,
							},
						],
					},
		...
		main: [
			{
				...
				subtitle: [
					...
					{
						txt: '시스템 성능 분석 페이지 개발',
						children: [
							{
								childTxt: '시스템 성능 분석 관련 총 2개 페이지 신규 개발',
								desc: null,
							},
							{
								childTxt: '위젯 데이터 지표 선택을 위한 커스텀 레이어 팝업 기능 설계 및 개발',
								desc: null,
							},
							{
								childTxt: '사용자 편의성을 고려한 인터랙션 설계',
								desc: null,
							},
							{
								childTxt: '메트릭 데이터 스케일 처리 공통 유틸 함수 개발로 코드 일관성 확보',
								desc: null,
							},
						],
					},
					{
						txt: 'Host 및 제품 튜닝 페이지 개발',
						children: [
							{
								childTxt: 'Host 및 제품 튜닝 관련 총 6개 페이지 개발 및 기본 데이터 세팅 구현',
								desc: null,
							},
							{
								childTxt: '불필요한 전체 리렌더링을 제거하고 컴포넌트 단위 렌더링으로 성능 개선',
								desc: null,
							},
						],
					},
					...
					{
						txt: '공통 컴포넌트 및 글로벌 함수 개발',
						children: [
							{
								childTxt: '[ ReportBaseChart ]',
								desc: [
									'트리쉐이킹을 위해 기존 BaseChart를 활용해 개발',
									'default상태를 지정해 데이터와 차트타입만 넘겨줘도 그려지도록 개발',
									'높은 자유도를 보장해 다양한 커스텀이 가능하도록 개발',
								],
							},
							{
								childTxt:
								...
								desc: [
									'ResizeObserver api 이용',
									'스타일 자유도를 높여 언제든 모드 추가가 가능하도록 개발',
								],
							},
							{
								childTxt:
									'[ BarChart / BarChartTooltip ] \n Common Grid 내부에서 사용되는 BarChart 및 BarChartTooltip.',
								desc: ['라이브러리 없이 직접 구현'],
							},
						],
					},
