...
const commonStyle = {
	...
	contentStyle: {
		...
		liquid: {
			...
			about: '',
			default: '',
			troubleshooting: 'flex gap-10 max-w-[310px]',
		},
	},
	subTitleSideStyle: {
		normal: {
